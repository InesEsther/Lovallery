...
public class DecisionManager2 : MonoBehaviour
{
    ...
    public DialogManagerDegas2 dialogManagerDegas2;
    ...
    void OnDecisionMade(bool isCorrect, int decisionNumber)
    {
        ...
        dialogManagerDegas2.ShowNextLine();
    }
    ...
    public void CheckPointsAndProceed()
    {
        ...
        if (PointManager1.Instance.GetPoints() >= 2)
        {
            ...
            SceneManager.LoadScene("DegasGoodEnd");
        }
        else
        {
            Debug.Log("Cargando escena Mala");
            SceneManager.LoadScene("DegasBadEnd");
        }
    }
}
