...
public class DialogManagerDegas2 : MonoBehaviour
{
    ...
    public DecisionManager2 decisionManager2;
    ...
    void Start()
    {
        ...
        TextAsset textAsset = Resources.Load<TextAsset>("EscenaDegasDialogo2");
        if (textAsset != null)
        {
    ...
    public void ShowNextLine()
    {
        ...
        if (currentLineIndex >= dialogLines.Length)
        {
            decisionManager2.CheckPointsAndProceed();
        }
    }
